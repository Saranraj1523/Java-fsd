...
public class RegistrationForm {
	...
	public void incorrectUsernameTest() {
		...
		driver.findElement(By.name("customerName")).sendKeys("Bala V");
		sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ap_customer_name\"]"));
		sleep(1000);
		driver.findElement(By.name("email")).sendKeys("9585619802");
		sleep(1000);
		driver.findElement(By.name("secondaryLoginClaim")).sendKeys("karankanagarajmalvoi@gmail.com");
		sleep(1000);
		driver.findElement(By.name("password")).sendKeys("karan@1");
		sleep(1000);
